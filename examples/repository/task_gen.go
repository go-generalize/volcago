...
func (repo *taskRepository) beforeInsert(ctx context.Context, subject *model.Task) error {
...
func (repo *taskRepository) beforeUpdate(ctx context.Context, old, subject *model.Task) error {
...
func (repo *taskRepository) beforeDelete(ctx context.Context, subject *model.Task, opts ...DeleteOption) error {
	repo.uniqueRepository.setMiddleware(ctx)
