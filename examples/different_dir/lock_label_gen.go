...
const (
	...
	LockIndexLabelSliceStringPrefix    = "s1" // prefix-match of SliceString
	LockIndexLabelSliceStringSuffix    = "s2" // suffix-match of SliceString
	LockIndexLabelSliceStringLike      = "s3" // like-match of SliceString
	LockIndexLabelSliceStringEqual     = "s4" // perfect-match of SliceString
	LockIndexLabelSliceNestedPrefix    = "s5" // prefix-match of SliceNested
	LockIndexLabelSliceNestedSuffix    = "s6" // suffix-match of SliceNested
	LockIndexLabelSliceNestedLike      = "s7" // like-match of SliceNested
	LockIndexLabelSliceNestedEqual     = "s8" // perfect-match of SliceNested
