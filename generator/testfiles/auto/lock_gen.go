...
func (repo *lockRepository) beforeInsert(ctx context.Context, subject *Lock) error {
...
func (repo *lockRepository) beforeUpdate(ctx context.Context, old, subject *Lock) error {
...
func (repo *lockRepository) beforeDelete(ctx context.Context, subject *Lock, opts ...DeleteOption) error {
	repo.setMeta(subject, false)
	repo.uniqueRepository.setMiddleware(ctx)
