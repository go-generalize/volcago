...
func (repo *lockMetaRepository) setMeta(subject *LockMeta, isInsert bool) {
	now := time.Now()
...
func (repo *lockMetaRepository) beforeInsert(ctx context.Context, subject *LockMeta) (RollbackFunc, error) {
...
func (repo *lockMetaRepository) beforeUpdate(ctx context.Context, old, subject *LockMeta) (RollbackFunc, error) {
...
func (repo *lockMetaRepository) beforeDelete(ctx context.Context, subject *LockMeta, opts ...DeleteOption) (RollbackFunc, error) {
	repo.setMeta(subject, false)
	repo.uniqueRepository.setMiddleware(ctx)
...
func (repo *lockMetaRepository) Search(ctx context.Context, param *LockMetaSearchParam, q *firestore.Query) ([]*LockMeta, error) {
	return repo.search(ctx, param, q)
}

// SearchByParam - search documents by search param
func (repo *lockMetaRepository) SearchByParam(ctx context.Context, param *LockMetaSearchParam) ([]*LockMeta, *PagingResult, error) {
	return repo.searchByParam(ctx, param)
}

// Get - get `LockMeta` by `LockMeta.ID`
func (repo *lockMetaRepository) Get(ctx context.Context, id string, opts ...GetOption) (*LockMeta, error) {
	doc := repo.GetDocRef(id)
	return repo.get(ctx, doc, opts...)
}

// GetWithDoc - get `LockMeta` by *firestore.DocumentRef
func (repo *lockMetaRepository) GetWithDoc(ctx context.Context, doc *firestore.DocumentRef, opts ...GetOption) (*LockMeta, error) {
	return repo.get(ctx, doc, opts...)
}

// Insert - insert of `LockMeta`
func (repo *lockMetaRepository) Insert(ctx context.Context, subject *LockMeta) (_ string, err error) {
...
func (repo *lockMetaRepository) Update(ctx context.Context, subject *LockMeta) (err error) {
	doc := repo.GetDocRef(subject.ID)
...
func (repo *lockMetaRepository) Delete(ctx context.Context, subject *LockMeta, opts ...DeleteOption) (err error) {
...
func (repo *lockMetaRepository) GetMulti(ctx context.Context, ids []string, opts ...GetOption) ([]*LockMeta, error) {
	return repo.getMulti(ctx, ids, opts...)
}

// InsertMulti - bulk insert of `LockMeta`
func (repo *lockMetaRepository) InsertMulti(ctx context.Context, subjects []*LockMeta) (_ []string, er error) {
...
func (repo *lockMetaRepository) UpdateMulti(ctx context.Context, subjects []*LockMeta) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
func (repo *lockMetaRepository) DeleteMulti(ctx context.Context, subjects []*LockMeta, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
func (repo *lockMetaRepository) DeleteMultiByIDs(ctx context.Context, ids []string, opts ...DeleteOption) (er error) {
	subjects := make([]*LockMeta, len(ids))
...
func (repo *lockMetaRepository) SearchWithTx(tx *firestore.Transaction, param *LockMetaSearchParam, q *firestore.Query) ([]*LockMeta, error) {
	return repo.search(tx, param, q)
}

// SearchByParamWithTx - search documents by search param in transaction
func (repo *lockMetaRepository) SearchByParamWithTx(tx *firestore.Transaction, param *LockMetaSearchParam) ([]*LockMeta, *PagingResult, error) {
	return repo.searchByParam(tx, param)
}

// GetWithTx - get `LockMeta` by `LockMeta.ID` in transaction
func (repo *lockMetaRepository) GetWithTx(tx *firestore.Transaction, id string, opts ...GetOption) (*LockMeta, error) {
	doc := repo.GetDocRef(id)
	return repo.get(tx, doc, opts...)
}

// GetWithDocWithTx - get `LockMeta` by *firestore.DocumentRef in transaction
func (repo *lockMetaRepository) GetWithDocWithTx(tx *firestore.Transaction, doc *firestore.DocumentRef, opts ...GetOption) (*LockMeta, error) {
	return repo.get(tx, doc, opts...)
}

// InsertWithTx - insert of `LockMeta` in transaction
func (repo *lockMetaRepository) InsertWithTx(ctx context.Context, tx *firestore.Transaction, subject *LockMeta) (_ string, err error) {
...
func (repo *lockMetaRepository) UpdateWithTx(ctx context.Context, tx *firestore.Transaction, subject *LockMeta) (err error) {
...
func (repo *lockMetaRepository) DeleteWithTx(ctx context.Context, tx *firestore.Transaction, subject *LockMeta, opts ...DeleteOption) (err error) {
	if len(opts) > 0 && opts[0].Mode == DeleteModeSoft {
		t := time.Now()
		subject.DeletedAt = &t
...
func (repo *lockMetaRepository) GetMultiWithTx(tx *firestore.Transaction, ids []string, opts ...GetOption) ([]*LockMeta, error) {
	return repo.getMulti(tx, ids, opts...)
}

// InsertMultiWithTx - bulk insert of `LockMeta` in transaction
func (repo *lockMetaRepository) InsertMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*LockMeta) (_ []string, er error) {
...
func (repo *lockMetaRepository) UpdateMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*LockMeta) (er error) {
	ctx = context.WithValue(ctx, transactionInProgressKey{}, 1)
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
...
func (repo *lockMetaRepository) DeleteMultiWithTx(ctx context.Context, tx *firestore.Transaction, subjects []*LockMeta, opts ...DeleteOption) (er error) {
	var rbs []RollbackFunc
	defer func() {
		if er == nil {
			return
...
func (repo *lockMetaRepository) get(v interface{}, doc *firestore.DocumentRef, opts ...GetOption) (*LockMeta, error) {
	var (
...
func (repo *lockMetaRepository) getMulti(v interface{}, ids []string, opts ...GetOption) ([]*LockMeta, error) {
	var (
	...
	subjects := make([]*LockMeta, 0, len(ids))
	mErr := NewMultiErrors()
...
func (repo *lockMetaRepository) insert(v interface{}, subject *LockMeta) (string, error) {
	var (
...
func (repo *lockMetaRepository) update(v interface{}, subject *LockMeta) error {
	var (
...
func (repo *lockMetaRepository) strictUpdate(v interface{}, id string, param *LockMetaUpdateParam, opts ...firestore.Precondition) error {
	...
	updates := updater(LockMeta{}, param)
...
func (repo *lockMetaRepository) runQuery(v interface{}, query firestore.Query) ([]*LockMeta, error) {
...
func (repo *lockMetaRepository) searchByParam(v interface{}, param *LockMetaSearchParam) ([]*LockMeta, *PagingResult, error) {
...
func (repo *lockMetaRepository) search(v interface{}, param *LockMetaSearchParam, q *firestore.Query) ([]*LockMeta, error) {
